...
- Unsupported platforms for this beta: <required: list excluded or explicitly unsupported platforms>
- Unsupported or partial features: <required: include pairing UI/device verification, native media/input gaps, and typed unsupported paths>
